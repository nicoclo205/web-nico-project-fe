...
const useAuth = () => {
  const logout = () => {
    // Placeholder logout implementation — replace with real auth logic
    // e.g. call your auth provider, clear tokens, redirect, etc.
    console.log("logout");
  };
    ...
    <div className="flex h-screen bg-[#0e0f11] text-white">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-10">
          <h1 className="text-3xl font-bold">¡Bienvenido a FriendlyBet! </h1>

          <div className="flex items-center space-x-4">
            <span className="text-gray-300">Nico</span>
